  ...
  return (
    <div className="flex  fixed  w-full  items-center justify-between text-white z-20 bg-black bg-opacity-80  rounded-lg">
      <div className=" flex p-3 items-center ">
        ...
        >
          <div
            className={`h-1 w-8 mb-1 bg-white transition-transform duration-500 ${visivel ? "rotate-45 translate-y-2" :""}`}
          />
          <div
      ...
      <div>
        <img src="./ico.png" className="relative z-10 h-16 sm:h-20 transition filter hover:filter-drop-shadow animate-pulse " alt="React logo" />
      </div>
      <div>
        <button className="text-white font-bold  rounded-full ">
          <FaUserCircle className="text-4xl  sm:text-5xl m-auto  "></FaUserCircle>
